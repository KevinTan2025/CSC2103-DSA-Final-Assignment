...
def display_menu():
    ...
    print("Note: Use only one data type per tree | Don't use duplicate values | Use comma (,) to seperate values in bulk insert")
    print("=" * 60)
    print("1.  Insert element")
    print("2.  Bulk insert from list (e.g. 10, 20, 30, 40, 50, 60,...)")
